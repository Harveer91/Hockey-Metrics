...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://127.0.0.1:5500","https://hockey-metrics.onrender.com", "https://hockey-metrics-1.onrender.com"],  # your frontend's URL
...
@app.get("/api/v1/draft/rankings/{season}/{prospect_category}")
